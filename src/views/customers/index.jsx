        ...
        <div className="flex ">
          <div className="max-w-lg">
            ...
            <label htmlfor="toggle-active" className="flex items-center cursor-pointer relative mb-4">
              <input type="checkbox" id="toggle-active" className="sr-only" onClick={activeFilter} />
            ...
            <label htmlfor="toggle-active" className="flex items-center cursor-pointer relative mb-4">
              <input type="checkbox" id="toggle-active" className="sr-only" onClick={notActiveFilter} />
              <div className="toggle-bg bg-gray-200 border-2 border-gray-200 h-6 w-11 rounded-full"></div>
              <span className="ml-3 text-gray-900 text-sm font-medium">
